...
app.post('/api/register', (req, res) => {
  ...
  const insertUserQuery = 'INSERT INTO users (nombre, email, password, telefono, pais, ciudad) VALUES ($1, $2, $3, $4, $5, $6)';
...
app.post('/api/login', (req, res) => {
  ...
  const selectUserQuery = 'SELECT * FROM users WHERE email = $1 AND password = $2';
